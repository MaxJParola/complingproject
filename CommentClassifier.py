...
df = pd.read_csv('MasterCleanCommentCoded.csv')      # to read the training data into working memory
...
lsvc_model = LinearSVC(max_iter=3000).fit(X_train_vectorized_tfidf, y_train)
